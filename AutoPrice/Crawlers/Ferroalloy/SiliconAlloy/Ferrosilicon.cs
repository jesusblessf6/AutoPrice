...
namespace AutoPrice.Crawlers.Ferroalloy.SiliconAlloy
{
     public class Ferrosilicon : ICrawler
    {
         private const int MarketId = 560;
        ...
        //硅铁
         public void Run()
         {
             ...
             try
             {
                 ...
                 var silicon = driver.FindElement(By.LinkText("硅系"));
                 ...
                 var ferrosilicons = driver.FindElements(By.LinkText(date + "国内硅铁价格汇总"));
