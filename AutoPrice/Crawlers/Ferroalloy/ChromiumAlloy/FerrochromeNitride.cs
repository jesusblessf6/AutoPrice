...
namespace AutoPrice.Crawlers.Ferroalloy.ChromiumAlloy
{
     public class FerrochromeNitride : ICrawler
    {
        private const int MarketId = 568;
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                var ferrosilicons = driver.FindElements(By.LinkText(date + "国内主要地区氮化铬铁市场价格汇总"));
