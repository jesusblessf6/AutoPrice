...
namespace AutoPrice.Crawlers.Ferroalloy.VanadiumAlloy
{
     public class VanadiumPowder : ICrawler
    {
        private const int MarketId = 562;
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                var silicon = driver.FindElement(By.LinkText("钒系"));
                ...
                var ferrosilicons = driver.FindElements(By.LinkText(date + "国内98、99粉钒主产区价格汇总"));
