...
namespace AutoPrice.Crawlers.Ferroalloy.TungstenAlloy
{
     public class TungstenConcentrate : ICrawler
    {
        private const int MarketId = 572;
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                var silicon = driver.FindElement(By.LinkText("钨系"));
                ...
                var ferrosilicons = driver.FindElements(By.LinkText(date + "钨精矿价格汇总"));
                if (ferrosilicons.Count > 0)
                {
                    ...
                    for (int i = 1; i < trs.Count; i++)
                    {
                        ...
                        if (tds[0].Text.Trim().Contains("金属吨"))
                        {
