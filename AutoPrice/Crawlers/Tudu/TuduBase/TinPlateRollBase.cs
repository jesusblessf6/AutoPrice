...
{
     public static class TinPlateRollBase
    {
         public static void GetData(int marketId, string linkName, string cityName, int hotnewsNum, string divID)
         {
             ...
             try
             {
                 ...
                 var hsteel = driver.FindElement(By.LinkText("镀锡板"));
                 driver.Navigate().GoToUrl(hsteel.GetAttribute("href"));
                 Thread.Sleep(2000);

                 var moreDiv = driver.FindElements(By.ClassName("wrap"))[0].FindElement(By.ClassName("right2")).FindElements(By.ClassName("rightcontent"))[2].FindElements(By.ClassName("hotnews"))[hotnewsNum].FindElement(By.Id(divID));
