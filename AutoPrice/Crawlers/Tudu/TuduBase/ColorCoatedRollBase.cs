...
{
     public static class ColorCoatedRollBase
    {
         public static void GetData(int marketId, string cityName, string linkText, int hotnewsNum, string divID)
         {
             ...
             try
             {
                 ...
                 var hsteel = driver.FindElement(By.LinkText("彩涂"));
                 driver.Navigate().GoToUrl(hsteel.GetAttribute("href"));
                 Thread.Sleep(2000);

                 var moreDiv = driver.FindElements(By.ClassName("wrap"))[1].FindElement(By.ClassName("right2")).FindElements(By.ClassName("rightcontent"))[2].FindElements(By.ClassName("hotnews"))[hotnewsNum].FindElement(By.Id(divID));
                 ...
                 var sh = driver.FindElement(By.LinkText(date + linkText));
